...
Classes/Structs that get inlined can be decorated with additional modifiers.  
Itself it does nothing, but you can also use it to make the usage of your base class/struct clear.

```csharp
using InlineCompositionAttributes;

[InlineBase] // itself it does nothing
